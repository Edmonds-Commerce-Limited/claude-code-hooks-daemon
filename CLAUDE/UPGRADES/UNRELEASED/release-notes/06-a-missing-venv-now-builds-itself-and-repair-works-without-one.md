...
`HOOKS_DAEMON_SKIP_VENV_BOOTSTRAP=1` switches this off.
...
Before this, it built a venv the resolver refused.
...
re-clone. Switching between the host and container views of one project no
