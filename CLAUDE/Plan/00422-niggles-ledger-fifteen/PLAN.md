...
| N17 | a stale `paths.py` docstring produced a confident wrong verdict          | triaging issue #53, by checking a sub-agent's finding before acting | ⬜ Open — recurrence of the class N5 row (e) closed as "defensible", now with evidence it actively misled a capable reader mid-investigation. Remedy (1) is one edit                                                                                                   |
