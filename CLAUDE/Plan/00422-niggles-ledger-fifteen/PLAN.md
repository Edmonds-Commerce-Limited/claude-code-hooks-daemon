...
| N5  | the v3.65.0 release reviews' NON-defects had no durable home             | the v3.65.0 release reviews                                        | 🔄 (a)(c)(d)(g) done, (f) corrected; seven rows left    |
...
- [ ] 🔄 **Task 2.1**: N5 — work the twelve-row table in
  ...
  config. Rows (g) and (c) are done by Plans 00436 and 00437 — the ALLOW-direction
  one and the racing one. Seven rows remain, (b) and (i) being the ones that
  matter.
