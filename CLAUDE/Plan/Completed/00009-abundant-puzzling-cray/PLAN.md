...
- **Account**: `~/.claude/.last-launch.conf` contains `LAST_TOKEN="client_user_a"`
...
# Test status line
# Expected: "client_user_a | Sonnet 4.5 | Ctx: 42.5% | daily: 15% | weekly: 45% | main | ⚡ 5m 12MB INFO"
```
...
```
client_user_a | Sonnet 4.5 | Ctx: 42.5% | daily: 15% | weekly: 45% | main | ⚡ 5m 12MB INFO
```

**Handler Order:**

1. AccountDisplayHandler (5): `"client_user_a |"`
