    ...
    def handle(self, hook_input: dict[str, Any]) -> HookResult:
        ...
        return HookResult(
            ...
            context=[
                ...
                "When modifying first-party vendor packages (client-a, lts):",
    ...
    def get_acceptance_tests(self) -> list[AcceptanceTest]:
        ...
        return [
            AcceptanceTest(
                ...
                command='echo "git add vendor/client-a/templates_php8/src/file.php"',
...
class TestVendorChangesReminderHandler:
    ...
    def test_matches_vendor_git_add(self) -> None:
        hook_input = {
            "toolName": "Bash",
            "toolInput": {"command": "git add vendor/client-a/templates_php8/src/file.php"},
        }
...
class BuildAssetCheckerHandler(Handler):
    ...
    def __init__(self) -> None:
        ...
        self._source_patterns = [
            r"vendor/client-a/templates_php8/web/assets/ts/",
            r"vendor/client-a/templates_php8/web/assets/scss/",
        ]
    ...
    def handle(self, hook_input: dict[str, Any]) -> HookResult:
        return HookResult(
            ...
            context=[
                ...
                "Run 'yarn build' or 'yarn watch' in vendor/client-a/templates_php8/web/ "
