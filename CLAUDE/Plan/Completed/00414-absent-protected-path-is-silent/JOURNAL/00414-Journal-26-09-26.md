...
merge accd1d87d, which both this plan's commits and 00415's are ancestors
...
(`CLAUDE/UPGRADES/UNRELEASED/release-notes/46-a-protected-path-your-config-names-but-lacks-is-now-reported.md`).
