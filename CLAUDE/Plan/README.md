...
- [00304: degraded mode fail open and visibility](00304-degraded-mode-fail-open-and-visibility/PLAN.md) - In Progress (php-qa-ci canary: a stale null legacy key put a real client into invisible fail-open degraded mode — release blocker for v3.58.0)
...
- **Folder-to-number reconciliation**: 37 + 244 + 7 = **288 folders**, spanning
