...
- **Completed**: 207 (includes 1 reduced-scope plan and 5 found already-shipped when audited; count = `Completed/` folders)
...
- **Folder-to-number reconciliation**: 34 + 207 + 6 = **247 folders**, spanning
...
- **Last reconciled by**: the Plan 00253 closure — the folder moved from the plan
