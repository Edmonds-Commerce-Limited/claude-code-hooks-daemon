...
- [00081: Pseudo-Events & Nitpick Handler](00081-pseudo-events-nitpick-handler/PLAN.md) - In Progress (Research Phase)
  - Introduces pseudo-events: synthetic events generated by daemon, triggered by real events
  - Nitpick pseudo-event: PreToolUse-triggered transcript auditing for language quality
  - Solves Stop event unreliability for dismissive/hedging language detection
  - **Priority**: High
