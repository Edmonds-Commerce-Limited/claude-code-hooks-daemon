...
- **Total Plans Created**: 293 (count = `hooksdaemon.latestPlanNumber` git counter)
...
- **Folder-to-number reconciliation**: 37 + 242 + 7 = **286 folders**, spanning
  **283 distinct plan numbers** — three numbers carry two folders each, the
  ...
  are on disk under `Completed/`, counted in the 283 distinct numbers above.
  283 + 10 = 293. ✅
