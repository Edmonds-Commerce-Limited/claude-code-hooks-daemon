...
- [00287: docs-qa pre-release punch list](00287-docs-qa-prerelease-punch-list/PLAN.md) - In Progress (pre-release punch list from the post-completion Fable review of Plan 00284: CLI lint severity inflation, two checks ignoring `grandfather_allowlist`, client-scaling exclusions, and the missing HANDLER_REFERENCE.md docs for the docs_qa trio)
...
- **Total Plans Created**: 287 (count = `hooksdaemon.latestPlanNumber` git counter)

- **Completed**: 237 (includes 1 reduced-scope plan and 5 found already-shipped when audited; count = `Completed/` folders)
...
- **Folder-to-number reconciliation**: 36 + 237 + 7 = **280 folders**, spanning
  **277 distinct plan numbers** — three numbers carry two folders each, the
  historic collisions already held in `collision_allowlist` (00034, 00039,
  00041). Plans 1–3 are on disk under the pre-zero-padding names
  (`001-`, `002-`, `003-`), so they count as present. That leaves **10** of the
  287 allocated numbers with no folder: 00005, 00015, 00036, 00073, 00074,
  ...
  that then found Plan 00208 already covered the work). 277 + 10 = 287. ✅
