...
- **Total Plans Created**: 278 (count = `hooksdaemon.latestPlanNumber` git counter)
...
- **Folder-to-number reconciliation**: 39 + 225 + 6 = **270 folders**, spanning
  **267 distinct plan numbers** — three numbers carry two folders each, the
