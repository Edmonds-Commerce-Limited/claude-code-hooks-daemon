...
- [00217: supervisor deployed into client owned path](00217-supervisor-deployed-into-client-owned-path/PLAN.md) - In Progress (four daemon-owned assets deploy outside the vendor dir into client-lintable space and none declared it)
