...
- **Total Plans Created**: 337 (count = `hooksdaemon.latestPlanNumber` git counter)
...
- **Folder-to-number reconciliation**: 45 + 275 + 7 = **327 folders**, spanning
...
- **Last reconciled at**: the Plan 00336 archival (45 root, 275 `Completed/`,
