...
**Assumed defaults (from the audit; correct me if wrong — NOTE: since refactored,
the supervisor now lives in the standalone deployed artefact
`.claude/ccy/claude-supervise.py`, see the 2026-07-09 journal entry)**:
supervisor lives in a `supervise/` package under the daemon source tree
(installer-shipped, full QA/95% bar,
...
The dated activity narrative that lived here (2026-06-22 → 2026-07-10: armed
live-fire post-mortems, slice-by-slice delivery notes, launcher-seam work) is
relocated verbatim to
[JOURNAL/00135-Journal-26-09-01.md](JOURNAL/00135-Journal-26-09-01.md).
