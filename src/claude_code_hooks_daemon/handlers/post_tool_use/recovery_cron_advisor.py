...
_CREATION_GUIDANCE: Final[str] = (
    ...
    "     Record THAT id in this plan's JOURNAL/ and create nothing.\n"
    ...
    "     Then record its id in this plan's JOURNAL/ — NOT in PLAN.md. Runtime\n"
    "     session state is journal content; PLAN.md stays a lean, curated spec.\n"
    "     Either way the entry goes through the stamping tool, never an edit of\n"
    "     the day-file: `mkplan.bash --journal <plan-number> action <body-file>`.\n"
