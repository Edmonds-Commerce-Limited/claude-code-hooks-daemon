"""Hello World handler for PermissionRequest - confirms hook system is active."""
...
class HelloWorldPermissionRequestHandler(Handler):
    """Simple test handler that confirms PermissionRequest hook is working.
    ...
    def get_acceptance_tests(self) -> list[Any]:
        ...
        return [
            AcceptanceTest(
                ...
                command='echo "test"',
                description="Test handler that confirms PermissionRequest hook is active",
                expected_decision=Decision.ALLOW,
                expected_message_patterns=[r"PermissionRequest hook system active"],
                safety_notes="Test handler only - always allows with context message",
                test_type=TestType.CONTEXT,
                requires_event="PermissionRequest event (cannot be triggered by subagent)",
