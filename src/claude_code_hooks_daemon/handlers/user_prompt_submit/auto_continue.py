"""AutoContinueHandler - automatically enhances minimal 'yes' responses with continuation context."""
...
class AutoContinueHandler(Handler):
    ...
    MINIMAL_RESPONSES: ClassVar[list[str]] = [
        "yes",
        "y",
        "yep",
        "yeah",
    ...
    def handle(self, hook_input: dict[str, Any]) -> HookResult:
        ...
        return HookResult(decision=Decision.ALLOW, context=[enhanced_prompt])
