...
class DartLintStrategy:
    ...
    def get_acceptance_tests(self) -> list[Any]:
        ...
        probe_valid = ToolPayload(
            ...
            tool_input={
                "file_path": acceptance_path(_FIXTURE_DIR, "valid.dart"),
        ...
        probe_invalid = ToolPayload(
            tool_name=ToolName.WRITE,
            tool_input={
                "file_path": acceptance_path(_FIXTURE_DIR, "invalid.dart"),
                "content": "void main( { print('hello'); }",
            },
        )
        ...
        return [
            AcceptanceTest(
                ...
                safety_notes=(
                    "Inside the gitignored acceptance directory - safe. Creates temporary Dart file."
                ),
