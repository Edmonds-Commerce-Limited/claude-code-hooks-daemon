...
_FIXTURE_DIR = "acceptance-test-tdd-swift"
...
class SwiftTddStrategy:
    ...
    def is_excluded_source_file(self, file_path: str) -> bool:
        """No Swift file is excluded from production source by name alone."""
        return False
    ...
    def get_acceptance_tests(self) -> list[Any]:
        ...
        probe = ToolPayload(
            ...
            tool_input={
                "file_path": acceptance_path(_FIXTURE_DIR, "Sources", "MyApp", "Parser.swift"),
        ...
        return [
            AcceptanceTest(
                ...
                setup_commands=[f"mkdir -p {fixture_root}/Sources/MyApp"],
