...
_FIXTURE_DIR = "acceptance-test-tdd-csharp"
...
class CSharpTddStrategy:
    ...
    def is_excluded_source_file(self, file_path: str) -> bool:
        """No C# file is excluded from production source by name alone."""
        return False
    ...
    def get_acceptance_tests(self) -> list[Any]:
        ...
        probe = ToolPayload(
            ...
            tool_input={
                "file_path": acceptance_path(_FIXTURE_DIR, "src", "Services", "UserService.cs"),
        ...
        return [
            AcceptanceTest(
                ...
                expected_message_patterns=[r"BLOCKED \[R-TDD-TEST-FIRST\]", r"C#", r"test file"],
                safety_notes=(
