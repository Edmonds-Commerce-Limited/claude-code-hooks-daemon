        ...
        return [
            AcceptanceTest(
                ...
                command=(
                    ...
                    "/tmp/acceptance-test-comment-changelog-shell/example.sh whose "
                ...
                setup_commands=["mkdir -p /tmp/acceptance-test-comment-changelog-shell"],
                cleanup_commands=["rm -rf /tmp/acceptance-test-comment-changelog-shell"],
