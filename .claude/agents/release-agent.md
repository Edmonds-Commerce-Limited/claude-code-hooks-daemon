...
CLAUDE/UPGRADES/UNRELEASED/release-notes/NNN-*.md in the author's own words —
...
```bash
mkdir -p .claude
git clone -b vX.Y.Z https://github.com/Edmonds-Commerce-Limited/claude-code-hooks-daemon.git .claude/hooks-daemon
