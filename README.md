...
![Version](https://img.shields.io/badge/version-3.63.0-blue)
![Python](https://img.shields.io/badge/python-3.11%20%7C%203.12%20%7C%203.13-blue)
![Platform](https://img.shields.io/badge/platform-Linux%20%7C%20macOS-lightgrey)
![License](https://img.shields.io/badge/license-MIT-green)
![Tests](https://img.shields.io/badge/tests-18000%2B%20passing-success)
...
Because handlers are Python classes with proper type annotations, you can write real unit tests. This project ships with 18,000+ tests and a 95% coverage requirement — the same standard applies to handlers you write for your own project. Catch regressions before restarting, not after.
...
<!-- ssot-quote: CLAUDE/Architecture/StatusLine.md#claude-code-settings-settingsjson -->
...
[CLAUDE/Architecture/StatusLine.md](CLAUDE/Architecture/StatusLine.md) owns the
full detail.
