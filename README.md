...
![Tests](https://img.shields.io/badge/tests-8543%2B%20passing-success)
...
Because handlers are Python classes with proper type annotations, you can write real unit tests. This project ships with 8,543+ tests and a 95% coverage requirement — the same standard applies to handlers you write for your own project. Catch regressions before restarting, not after.
...
The daemon ships with 74 production handlers across 13 event types, covering the most common AI-assisted development guardrails:
