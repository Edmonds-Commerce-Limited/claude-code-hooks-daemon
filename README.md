...
![Tests](https://img.shields.io/badge/tests-8070%2B%20passing-success)
...
Because handlers are Python classes with proper type annotations, you can write real unit tests. This project ships with 8,070+ tests and a 95% coverage requirement — the same standard applies to handlers you write for your own project. Catch regressions before restarting, not after.
